...
class ImageFileReaderStreamingTest:
...
<ImageType>( extractor->GetOutput(), 
  ...
  int Test(int argc, char* argv[])
  {
    ...
    itkImageFileWriterStreamingTest2( inputFileName.GetPathName(), this->GenerateFileName( fileExtension ) );

    
    itkImageFileWriterStreamingTest1( inputFileName, this->GenerateFileName( fileExtension ), false, false );
    itkImageFileWriterStreamingTest1( inputFileName, this->GenerateFileName( fileExtension ), true, false );
    itkImageFileWriterStreamingTest1( inputFileName, this->GenerateFileName( fileExtension ), false, true );
    itkImageFileWriterStreamingTest1( inputFileName, this->GenerateFileName( fileExtension ), true, true );
...
int itkImageFileReaderStreamingTest(int argc, char* argv[])
{
  ...
  ImageFileReaderStreamingTest test;
